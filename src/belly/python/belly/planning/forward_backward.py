...
class forward_backward( belly.opencl.Program ):
  def __init__( self ):
    belly.opencl.Program.__init__( self )
    self.flow = self.loadProgram( belly.BASE_DIR + "/opencl/forwardBackward.cl" )
